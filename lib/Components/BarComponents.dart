...
class Barcomponents {
  ...
  static Stack idiotClubBar(Size screen) {
    return Stack(
      children: [
        Container(
          height: screen.height / 6.5,
          ...
          children: [
            ...
            ClipOval(
              child: Container(
                ...
                child: Image.asset("assets/images/Profile/RedPanda.jpeg"),
              ),
            ),
            SizedBox(
              width: 10,
          ...
          onTap: (value) {
            ...
            switch (value) {
              ...
              case 1:
                ...
                break;
              case 2:
                Navigator.pushNamed(context, "/joinedClub");
                break;
            }
          },
          items: [
  ...
  static Stack getIdiotSearchBar() {
    return Stack(
      children: [
        Container(
